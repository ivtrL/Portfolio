...
const Skill = (props: ISkill) => {
  ...
  return (
    <motion.div
      className="flex items-center justify-center rounded-full font-semibold dark:bg-light bg-dark dark:text-dark text-light py-3 px-6 shadow-dark absolute"
  ...
  return (
    <>
      ...
      <div className="w-full h-screen relative flex items-center justify-center rounded-full bg-circularLight dark:bg-circularDark">
        <motion.div
          className="flex items-center justify-center rounded-full font-semibold dark:bg-light bg-dark dark:text-dark text-light p-8 shadow-dark"
          whileHover={{ scale: 1.05 }}
        >
          Dev
        </motion.div>
